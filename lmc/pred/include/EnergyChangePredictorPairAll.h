...
#ifndef LMC_PRED_INCLUDE_ENERGYCHANGEPREDICTORPAIRALL_H_
#define LMC_PRED_INCLUDE_ENERGYCHANGEPREDICTORPAIRALL_H_
#include <string>
...
#endif //LMC_PRED_INCLUDE_ENERGYCHANGEPREDICTORPAIRALL_H_
