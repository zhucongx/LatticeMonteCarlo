...
//     std::unordered_map<ElementCluster, size_t,
//                        boost::hash<ElementCluster> > initialized_cluster_hashmap) {
//   auto neighbors_lattice_id_set =
//       cfg::GetNeighborsLatticeIdSetOfJumpPair(config, lattice_id_jump_pair);
...
//     std::cerr << cluster_count.first << ':' << cluster_count.second << ", ";
//
//     res.push_back(cluster_count.second);
//   }
//   std::cerr << '\n';
//
//   return res;
...
//   }
//   auto start_encode = GetClusterEncode(element_vector_start,
//                                        mapping_periodic_,
