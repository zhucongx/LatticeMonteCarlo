...
#ifndef LMC_PRED_INCLUDE_ENERGYCHANGEPREDICTORPAIR_H_
#define LMC_PRED_INCLUDE_ENERGYCHANGEPREDICTORPAIR_H_
#include <string>
#include <set>
...
#endif //LMC_PRED_INCLUDE_ENERGYCHANGEPREDICTORPAIR_H_
