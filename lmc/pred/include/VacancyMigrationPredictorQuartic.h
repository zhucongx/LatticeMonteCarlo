...
#ifndef LMC_PRED_INCLUDE_VACANCYMIGRATIONPREDICTORQUARTIC_H_
#define LMC_PRED_INCLUDE_VACANCYMIGRATIONPREDICTORQUARTIC_H_
#include <string>
#include <set>
...
#endif //LMC_PRED_INCLUDE_VACANCYMIGRATIONPREDICTORQUARTIC_H_
