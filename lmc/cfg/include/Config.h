...
class Config {
 public:
  ...
  [[nodiscard]] double GetTotalSoluteMass() const;
  [[nodiscard]] Vector_d GetSoluteCenterOfMass() const;
  // Modify config
