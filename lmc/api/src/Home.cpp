...
void Run(const Parameter &parameter) {
  if (parameter.method == "Reformat") {
    ...
    //   auto canonical_mc_serial = BuildCanonicalMcSerialFromParameter(parameter);
    //   canonical_mc_serial.Simulate();
    // } else if (parameter.method == "CanonicalMcOmp") {
    //   auto canonical_mc_omp = BuildCanonicalMcOmpFromParameter(parameter);
    //   canonical_mc_omp.Simulate();
    // } else if (parameter.method == "KineticMcFirstMpi") {
    //   auto kinetic_mc_first_mpi = BuildKineticMcFirstMpiFromParameter(parameter);
    //   kinetic_mc_first_mpi.Simulate();
    // } else if (parameter.method == "KineticMcFirstOmp") {
    //   auto kinetic_mc_first_omp = BuildKineticMcFirstOmpFromParameter(parameter);
    //   kinetic_mc_first_omp.Simulate();
    // } else if (parameter.method == "KineticMcChainOmpi") {
    //   auto kinetic_mc_chain_ompi = BuildKineticMcChainOmpiFromParameter(parameter);
...
//   }
//   Config config = Config::ReadConfig(parameter.config_filename_);
//   config.UpdateNeighborList({3.5, 4.8, 5.3,})
